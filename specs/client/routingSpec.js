...
describe("Routing", function() {
  ...
  it("Should have /signup route, template, and controller", function() {
    ...
    expect($route.routes["/signup"].templateUrl).to.equal(
  ...
  it("Should have /links route, template, and controller", function() {
    ...
    expect($route.routes["/links"].templateUrl).to.equal(
      "app/links/links.html"
    );
  });
  ...
  it("Should have /shorten route, template, and controller", function() {
    ...
    expect($route.routes["/shorten"].templateUrl).to.equal(
      "app/shorten/shorten.html"
    );
  });
});
